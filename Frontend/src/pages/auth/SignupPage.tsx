    ...
    <div className="min-h-screen bg-gradient-to-br from-neutral-50 to-indigo-50 flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-neutral-500 mt-1">Get your AI assistant up in minutes</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-neutral-200 shadow-sm p-6">
          <form onSubmit={form.handleSubmit(onSubmit)} noValidate>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={cn(
                  ...
                  form.formState.errors.name ? 'border-red-300' : 'border-neutral-300',
                )}
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className={cn(
                  'w-full px-3 py-2.5 rounded-lg border text-sm outline-none transition-colors',
                  'focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500',
                  form.formState.errors.email ? 'border-red-300' : 'border-neutral-300',
                )}
            ...
            <div className="mb-5">
              ...
              <div className="relative">
                <input
                  ...
                  className={cn(
                    'w-full pr-10 pl-3 py-2.5 rounded-lg border text-sm outline-none transition-colors',
                    'focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500',
                    form.formState.errors.password ? 'border-red-300' : 'border-neutral-300',
                  )}
            ...
            >
              {signupMutation.isPending ? <Loader2 size={16} className="animate-spin" /> : <ArrowRight size={16} />}
            ...
            <div className="grid grid-cols-2 gap-3">
              <button type="button" onClick={() => toast.info('Coming soon!')} className="flex items-center justify-center gap-2 border border-neutral-300 rounded-lg py-2.5 px-3 text-sm font-medium text-neutral-700 hover:bg-neutral-50 transition-colors">
